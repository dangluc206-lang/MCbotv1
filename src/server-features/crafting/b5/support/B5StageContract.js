...
/**
 * Runtime contract for B1 -> B5 stage transitions.
 * A stage may hand off to the next stage only after input, output and
 * relevant inventory settlement are all proven for the current generation.
 */
class B5StageContract {
...
module.exports = B5StageContract;
