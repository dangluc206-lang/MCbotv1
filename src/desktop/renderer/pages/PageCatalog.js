(function universal(root, factory) {
  ...
  return Object.freeze({
    ...
    modes:Object.freeze({ title:'Chế độ', subtitle:'B5 thuần, bảo vệ kho, Skyblock và các chế độ hiện có', group:'USER' }),
    ...
    'b5-debug':Object.freeze({ title:'Dev · B5 Debug', subtitle:'Journey, trace replay, blocker và verification B5', group:'DEV' }),
